...
class UpdateWeightFromTensor:
    ...
    def update_weights(self) -> None:
        ...
        # Include distributed engines in lifecycle management so that vLLM
        # engines (which are always routed to the distributed path) are
        # properly paused/flushed/continued.
        all_engines = list(self.rollout_engines)
        if self.use_distribute:
            all_engines.extend(self.distributed_rollout_engines)
